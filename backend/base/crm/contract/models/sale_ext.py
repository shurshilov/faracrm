    ...
    async def sale_invoice_rus(env: "Environment", record_id: int) -> dict:
        ...
        sale = await env.models.sale.search_one(
            ...
            fields_nested={
                ...
                # "company_id.chief_id": {"fields": ["id", "name"]},
                # "company_id.accountant_id": {"fields": ["id", "name"]},
                "order_line_ids": {
                    "fields": [
                        "id",
                        "sequence",
                ...
                # "order_line_ids.product_id": {"fields": ["id", "name"]},
                # "order_line_ids.product_uom_id": {"fields": ["id", "name"]},
                # "order_line_ids.tax_id": {"fields": ["id", "amount"]},
            },
        )
