...
| `use_anonymous_session` | Ничего, прав не даёт: нужное ручка читает сама через `.sudo()` | Публичный конфиг и брендинг, каталог маркетплейса, WebSocket-роуты, публичные иконки |
